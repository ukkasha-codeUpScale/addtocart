...
import { UserCredentialsEntity } from '@/models/user.credential.entity'
...
export default function Login() {
    ...
    const form = useFormik({
        initialValues:new UserCredentialsEntity(),
        validationSchema: UserCredentialsEntity.UserLoginSchema(),
        onSubmit:async (values)=>{
          try{
            const res = await axios.post(
              ...
              console.log(res.data,"=========Response from stapi");
        }
        catch(er){
            console.log(er)
            router.push('/login')
      ...
      >
        ...
        >
          ...
          <p className="mt-6 font-normal text-center text-gray-300 md:mt-0">
           Login to your Dashboard to view each and every decision you make on this platform, <br/>
           Lets access to new world!
          </p>
        ...
        <div className="p-5 bg-white md:flex-1">
          ...
          <form onSubmit={form?.handleSubmit} className="flex flex-col space-y-5">
            ...
            <div className="flex flex-col space-y-1">
              <label htmlFor="identifier" className="text-sm font-semibold text-gray-500">User Name</label>
             
             
              <input
              type='text' name='identifier' onChange={form.handleChange} value={form.values.email}
                id="identifier"
            ...
            <div className="flex flex-col space-y-1 text-black">
              ...
              <input
              type='password' name='password' onChange={form.handleChange} value={form.values.password}
                id="password"
